...
urlpatterns = [
       ...
       # re_path(r'sightings/<uuid:pk>', views.squirrel_update, name='update'),
        re_path(r'sightings/(?P<unique_squirrel_id>\w+\-\w+\-\d{4}\-\d{2})/update', views.squirrel_update,name = 'update'),
